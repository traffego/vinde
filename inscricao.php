...
<main class="inscricao-main">
    ...
    <div class="container">
        <!-- Header Premium da Inscrição -->
        <section class="inscricao-header-premium">
            <div class="inscricao-header-content">
                ...
                <h1>Complete sua Inscrição</h1>
                
                <div class="evento-card-inscricao">
                        ...
                        <div class="evento-meta">
                            <div class="meta-item">
                                ...
                                <?php if ($evento['horario_inicio']): ?>
                                    <span class="time">às <?= date('H:i', strtotime($evento['horario_inicio'])) ?></span>
                                <?php endif; ?>
                            </div>
                            <div class="meta-item">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <div class="evento-info-right">
                        <div class="vagas-info">
                            <div class="vagas-number"><?= $evento['vagas_restantes'] ?></div>
                            <div class="vagas-label">vagas restantes</div>
                            <div class="vagas-total">de <?= $evento['limite_participantes'] ?> no total</div>
                        </div>
                        
                        <?php if ($evento['valor'] > 0): ?>
                            <div class="price-info">
                                <div class="price-value">R$ <?= number_format($evento['valor'], 2, ',', '.') ?></div>
        ...
        <!-- Formulário Premium -->
        <section class="inscricao-form-premium">
            <div class="form-container">
                ...
                <form method="POST" id="form-inscricao" class="form-premium" novalidate>
